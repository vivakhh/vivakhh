...
async def post_article():
    title = "오늘의 쿠팡 골드박스 특가! 놓치면 후회할 초특가 찬스 🎁 (수정본)"
    content_html = """
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # TRIGGER REACT STATE: focus the iframe and press a key, or use tinymce API
            print("Triggering TinyMCE change event...")
            await page.evaluate("tinymce.activeEditor.fire('change')")
            
            # Also try typing a space at the end to force React to notice
